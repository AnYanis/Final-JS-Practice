...
import { searchBarAll } from './checkout/searchbar.js';

// Load products from backend, then draw the grid
loadProductsFetch().then(renderProductsGrid).then(searchBarAll);
function renderProductsGrid() {
  ...
  products.forEach((product) => {
    productsHTML += `
    <div class="product-container" data-product-id="${product.id}" id="product-${product.id}">
